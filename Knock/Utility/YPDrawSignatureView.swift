...
final public class YPDrawSignatureView: UIView {
    ...
    public func getSignature(_ scale:CGFloat = 1) -> UIImage? {
    ...
    public func getCroppedSignature(_ scale:CGFloat = 1) -> UIImage? {
        guard let fullRender = getSignature(scale) else { return nil }
