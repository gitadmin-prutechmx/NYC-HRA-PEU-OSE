...
public class GaugeView: UIView {
  ...
  //Gauge property
  @IBInspectable public var startAngle: Float = 10.0
  ...
  @IBInspectable public var gaugeColor: UIColor = UIColor(red: CGFloat(18.0/255), green: CGFloat(136.0/255), blue: CGFloat(189.0/255), alpha: 1)
