...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool
    {
        ...
        CustomNotificationCenter.registerReceiver(receiver: self.broadcastReceiver, notificationName: SF_NOTIFICATION.APP_TIMEOUT)
...
extension AppDelegate:BroadcastReceiverDelegate{
    ...
    func onReceive(notification: NSNotification) {
        ...
        if (notification.name.rawValue == SF_NOTIFICATION.APP_TIMEOUT.rawValue){
             Static.isSessionExpired = true
             Logger.shared.log(level: .info, msg: "Timeout")
