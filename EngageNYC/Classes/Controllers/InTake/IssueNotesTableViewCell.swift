...
class IssueNotesTableViewCell: UITableViewCell
{
    ...
    func setupView(forCellObject object : IssueNoteDO,index: IndexPath) {
        ...
        lblNotes.text = object.issueNotes
