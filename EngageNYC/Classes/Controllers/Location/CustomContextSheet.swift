...
//            self.selectionLabel.backgroundColor = UIColor.redColor()
    ...
    func attributedText(_ title:String) -> NSAttributedString {
        let attributes = [NSStrokeWidthAttributeName: -3, NSStrokeColorAttributeName: UIColor.blue, NSForegroundColorAttributeName: UIColor.white, NSFontAttributeName: UIFont.boldSystemFont(ofSize: 18)] as [String : Any]
